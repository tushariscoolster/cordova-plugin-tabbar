...
- (void) setBackground:(CDVInvokedUrlCommand*)command
{
    if (!tabBar) {
        return;
    }
    
    NSString  *background = [command.arguments objectAtIndex:0];
    
    [tabBar setBackgroundImage:[UIImage imageNamed:background]];
}
