...
TabBar.prototype.hide = function(animate) {
    if (animate === undefined || animate === null)
        animate = true;
    cordova.exec(null, null, "TabBar", "hide", [{animate: animate}]);
};
...
TabBar.prototype.show = function(options) {
    cordova.exec(null, null, "TabBar", "show", [options || {}]);
};
...
TabBar.prototype.showItems = function() {
    var parameters = [null, null, "TabBar", "showItems"];
    var options = [];
...
{
    cordova.exec(null, null, "TabBar", "setBackground", [background]);
};
